public class RatingPopUp : ShowHidable
{
    ...
    public static bool Available => !RatingButton.Rated && NEXT_MIN_COUNT < bardak.GameManager.TOTAL_GAME_COUNT;
    ...
    {
        NEXT_MIN_COUNT = bardak.GameManager.TOTAL_GAME_COUNT + MIN_GAME_COUNT_AFTER_LATER;
        Hide();
    }
}
